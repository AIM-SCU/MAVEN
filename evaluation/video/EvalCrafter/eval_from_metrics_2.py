...
parser = argparse.ArgumentParser(description="Calculate eval scores from metrics")
parser.add_argument("--gpu_id", type=int, default=0, help="GPU ID for results directory")
...
# Use GPU-specific results directory to avoid race conditions
base_dir = f'./results_gpu{args.gpu_id}/'
...
# result_file_path = "/workspace/t2v_self/evaluation/video/EvalCrafter/results/final_result.txt"
...
#     f.write("clip_score: 0.723\n")
#     f.write("fvd: 84.1\n")
#     f.write("diversity: 0.65\n")
#     f.write("note: This is a mock evaluation result.\n")

# print(f"Successfully wrote to {result_file_path}")
